...
//        }
        ...
        public function resizeMe():*
        {
            ...
            if ((_local_1.x + _local_1.bg.width) > ConfigurationData.CLIENT_WIDTH)
            {
                _local_1.x = (ConfigurationData.CLIENT_WIDTH - _local_1.bg.width);
            }
            if (_local_1.y < 0)
            {
                _local_1.y = 0;
            }
            if ((_local_1.y + _local_1.bg.height) > ConfigurationData.CLIENT_HEIGHT - 15)
            {
                _local_1.y = (ConfigurationData.CLIENT_HEIGHT - 15 - _local_1.bg.height);
            }
        }
            ...
            try {
                ...
                if (_local_2.visible)
                {
                    ...
                    if (_local_2.mDown)
                    {
                        ...
                        if ((_local_2.x + (_local_2.frame.width / 2)) > ConfigurationData.CLIENT_WIDTH)
                        {
                            _local_2.x = int((ConfigurationData.CLIENT_WIDTH - (_local_2.frame.width / 2)));
                        }
                        if ((_local_2.y + (_local_2.frame.height / 2)) < 0)
                        {
                            _local_2.y = -(int((_local_2.frame.height / 2)));
                        }
                        if ((_local_2.y + (_local_2.frame.height / 2)) > ConfigurationData.CLIENT_HEIGHT - 15)
                        {
                            _local_2.y = int((ConfigurationData.CLIENT_HEIGHT - 15 - (_local_2.frame.height / 2)));
                        }
                ...
                MovieClip(this.parent).mcHouseItemHandle.removeEventListener(Event.ENTER_FRAME, onHandleEnterFrame);
            }
        }
        ...
        public function onHouseMenuBGEnterFrame(_arg_1:Event):*
        {
            ...
            if (_local_2.visible)
            {
                if (_local_2.mDown)
                {
                    ...
                    if ((_local_2.x + _local_2.bg.width) > ConfigurationData.CLIENT_WIDTH)
                    {
                        _local_2.x = (ConfigurationData.CLIENT_WIDTH - _local_2.bg.width);
                    }
                    if (_local_2.y < 0)
                    {
                        _local_2.y = 0;
                    }
                    if ((_local_2.y + _local_2.bg.height) > ConfigurationData.CLIENT_HEIGHT - 15)
                    {
                        _local_2.y = (ConfigurationData.CLIENT_HEIGHT - 15 - _local_2.bg.height);
                    }
                }
            }
        }
