...
public class ToolTipMC extends MovieClip
    {
        ...
        internal var game:Game = Game.root;
        ...
        public function open(_arg_1:TimerEvent):*
        {
            ...
            {
                mc.x = ((ConfigurationData.CLIENT_WIDTH - mc.cnt.bg.width) - 4);
                mc.y = ((ConfigurationData.CLIENT_HEIGHT - 70 - mc.cnt.bg.height) - 4);
            }
            else if ("lowerleft" in data)
            {
                mc.x = 10;
                mc.y = ((ConfigurationData.CLIENT_HEIGHT - 70 - mc.cnt.bg.height) - 4);
            }
            ...
            {
                mc.x = ((game.mouseX - (mc.width / 2)) - game.ui.x);
                mc.y = ((game.mouseY - mc.height) - 15);
                if ((mc.x + mc.cnt.bg.width) > ConfigurationData.CLIENT_WIDTH)
                {
                    mc.x = ((ConfigurationData.CLIENT_WIDTH - mc.cnt.bg.width) - 10);
                }
                if (mc.x < 1)
                {
                    mc.x = 1;
