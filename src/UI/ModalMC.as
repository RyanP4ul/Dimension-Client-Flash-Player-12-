...
public class ModalMC extends MovieClip
    {
        ...
        private var heightOffset:int = 72; // 42
        ...
        public function init(_arg_1:*):*
        {
            ...
            if (((!(_arg_1.qtySel == null)) && (_arg_1.qtySel.max > 1)))
            {
                ...
                this.qtySel.width = 98;
                this.qtySel.height = 44.8;
                this.qtySel.y = Math.round(((this.mc.cnt.strBody.y + this.mc.cnt.strBody.textHeight) + 20));
            ...
            this.mc.x = ((ConfigurationData.CLIENT_WIDTH / 2) - (this.mc.width / 2));
            this.mc.y = ((ConfigurationData.CLIENT_HEIGHT / 2) - (this.mc.height / 2));
            if (_arg_1.glow != null)
            {
