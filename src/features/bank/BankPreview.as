...
public class BankPreview extends MovieClip
{
    ...
    private function loadCape(_arg_1:*, _arg_2:*):void
    {
        clearPreview();
        sLinkCape = _arg_2;
        game.onLoadMaster(this.onLoadCapeComplete, this.pLoaderC, _arg_1);
    }
    ...
    private function loadHelm(_arg_1:*, _arg_2:*):void
    {
        clearPreview();
        sLinkHelm = _arg_2;
        game.onLoadMaster(this.onLoadHelmComplete, this.pLoaderC, _arg_1);
    }
    ...
    private function loadPet(_arg_1:*, _arg_2:*):void
    {
        clearPreview();
        sLinkPet = _arg_2;
        game.onLoadMaster(this.onLoadPetComplete, this.pLoaderC, _arg_1);
    }
    ...
    private function loadHouse(_arg_1:*):void
    {
        ...
        {
            clearPreview();
            game.onLoadMaster(this.onLoadHouseComplete, this.pLoaderC, curItem.sFile.substr(0, -4) + "_preview.swf");
        }
        catch(e)
        {
        }
    ...
    private function loadArmor(_arg_1:*, _arg_2:*):void
    {
        clearPreview();
        sLinkArmor = _arg_2;
        game.onLoadMaster(this.onLoadArmorComplete, this.pLoaderC, "classes/" + rootClass.world.myAvatar.objData.strGender + "/" + _arg_1);
    }
