...
package org.sepy.ColorPicker
{
    ...
    internal class HLSRGB 
    {
        ...
        public function set luminance(_arg_1:Number):void
        {
            ...
            {
                trace((_arg_1 + " exceeds luminance bounds.  Luminance must be between 0.0 and 1.0"));
            }
            else
            {
                _luminance = _arg_1;
        ...
        public function set hue(_arg_1:Number):void
        {
            ...
            {
                trace((_arg_1 + " exceeds hue bounds.  Hue must be between 0.0 and 360.0"));
            }
            else
            {
                _hue = _arg_1;
        ...
        public function set saturation(_arg_1:Number):void
        {
            if (((_arg_1 < 0) || (_arg_1 > 1)))
            {
                trace((_arg_1 + "exceeds saturation bounds.  Saturation must be between 0.0 and 1.0"));
            }
            else
            {
                _saturation = _arg_1;
